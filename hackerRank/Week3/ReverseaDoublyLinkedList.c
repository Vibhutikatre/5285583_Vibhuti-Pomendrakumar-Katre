...
DoublyLinkedListNode* reverse(DoublyLinkedListNode* llist) {
    ...
    DoublyLinkedListNode* Recent_Node = llist;
    DoublyLinkedListNode* IC_Node = NULL;

    while (Recent_Node != NULL) {
        IC_Node = Recent_Node->prev;
        Recent_Node->prev = Recent_Node->next;
        Recent_Node->next = IC_Node;
